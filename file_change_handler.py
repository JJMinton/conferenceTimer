...
class FileChangeHandler(PatternMatchingEventHandler):
    ...
    def process(self, schedule_file_name=None):
        ...
        logging.info('FileChangeHnadler.process: Processing {}'.format(schedule_file_name))
        ...
        logging.info('FileChangeHandler.process: Starting new async_task')
        self.async_task = asyncio.ensure_future(self.controller_function(df, self.loop, *self.args), loop=self.loop)
        logging.info('FileChangeHandler.process: Return from processing')
        return
