...
class Screen():
    ...
    def starting(self, name=None, title=None, endTime=None):
        async def starting(loop):
            while True:
                print(name, title, 'Starting in: {:}'.format(formatted_count_down(endTime)))
    ...
    def speaking(self, name=None, title=None, endTime=None):
        async def speaking(loop):
            while True:
                print(name, title, 'Speaking for: {:}'.format(formatted_count_down(endTime)))
    ...
    def questions(self, name=None, title=None, endTime=None):
        async def questions(loop):
            while True:
                print(name, title, 'Questions for: {:}'.format(formatted_count_down(endTime)))
